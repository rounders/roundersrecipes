...
Capistrano::Configuration.instance(:must_exist).load do
  ...
  role :web, "159.89.137.221"                          # Your HTTP server, Apache/etc
  role :app, "159.89.137.221"                          # This may be the same as your `Web` server
  role :db,  "159.89.137.221", :primary => true        # This is where Rails migrations will run
